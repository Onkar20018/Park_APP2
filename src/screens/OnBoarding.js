...
const OnBoard =({navigation})=>{
  ...
  <SafeAreaView>
    ...
    <View style={{height:Dheight,width:Dwidth,borderRadius:10,borderWidth:2, backgroundColor:"paleturquoise"}}>
           <Text style={{marginLeft:35,fontSize:50,marginTop:100}}>Welcome,</Text>        
           <Text style={{marginLeft:50,fontSize:20,marginTop:20,color:"darkgrey"}}>Leave the hectic task of finding parking spot to Us</Text>
           <Text style={{marginLeft:50,fontSize:20,marginTop:12,color:"darkgrey"}}>Live update of each parking spot is provided in a Single Click</Text>
