...
const OnBoard =({navigation})=>{
  ...
  <SafeAreaView>
    ...
    <View style={{height:Dheight,width:Dwidth,borderRadius:10,borderWidth:5, backgroundColor:"paleturquoise"}}>
           ...
           <Text style={{marginLeft:50,fontSize:20,marginTop:12,color:"darkgrey"}}>Leave the hectic task of finding parking spot to Us</Text>
